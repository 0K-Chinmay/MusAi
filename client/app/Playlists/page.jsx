  ...
  return (
    ...
    <div className='absolute h-full w-[100%] z-0 bottom-0 flex
     flex-wrap justify-center items-center' >
      <RxCross2 className={pl?' absolute z-30 cursor-pointer top-14 right-8':'hidden'} size={40} onClick={()=>{setpl(false)}} />
      ...
      {pl?
      <div className='absolute bg-black h-screen w-screen flex items-center justify-center bg-opacity-[0.6] z-20'>
